...
```
## Training
To reproduce the results of EM-HGNN on four widely used datasets, please run following commands. All hyperparameters related to the datasets are stored in the **args.yaml** file.
